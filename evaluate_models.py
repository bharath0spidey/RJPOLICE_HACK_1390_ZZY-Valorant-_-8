...
def main(args):
    ...
    def evaluate_nn(model_paths, datasets_paths, model_config, amount_to_use, device, batch_size):
        # ... (move the content of evaluate_nn here)
        ...
        device=device,
        batch_size=8,  # You can adjust this value based on your needs
    )
